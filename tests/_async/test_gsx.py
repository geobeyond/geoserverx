...
async def test_all_workspaces(
    client: AsyncGeoServerX, httpx_mock: HTTPXMock, good_workspaces_connection
):
...
async def test_workspace_success(
    client: AsyncGeoServerX, httpx_mock: HTTPXMock, good_workspace_connection
):
...
async def test_workspace_fail(
    client: AsyncGeoServerX, httpx_mock: HTTPXMock, bad_workspace_connection
):
...
async def test_get_vector_stores_in_workspaces_no_ws_fail(
    client: AsyncGeoServerX, httpx_mock: HTTPXMock, bad_datastore_item_connection
):
...
async def test_get_vector_stores_in_workspaces_success(
    client: AsyncGeoServerX, httpx_mock: HTTPXMock, good_datastores_model_connection
):
...
async def test_allstyles_success(
    client: AsyncGeoServerX, httpx_mock: HTTPXMock, good_all_styles_model_connection
):
...
async def test_allstyles_fail(
    client: AsyncGeoServerX, httpx_mock: HTTPXMock, bad_all_styles_model_connection
):
...
async def test_style_success(
    client: AsyncGeoServerX, httpx_mock: HTTPXMock, good_style_model_connection
):
...
async def test_style_fail(
    client: AsyncGeoServerX, httpx_mock: HTTPXMock, bad_style_model_connection
):
